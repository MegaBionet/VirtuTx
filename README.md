...
=>conda env create -f environment.yml conda activate gpu_env

STEP 2: DATA CURATION AND SIGNATURE GENERATION
...
STEP 3: VERIFY DATA SPLIT INTEGRITY
...
STEP 4: TRAIN THE CONDITIONAL VAE (STAGE 1)
...
STEP 5: TRAIN THE LATENT DIFFUSION MODEL (STAGE 2)
...
STEP 6A: QUANTITATIVE ZERO-SHOT EVALUATION
...
STEP 6B: QUANTITATIVE ZERO-SHOT EVALUATION On EXTERNAL DATASET
...
STEP 7: DEEP QUALITATIVE ZERO-SHOT VALIDATION
...
STEP 8: PATHWAY DISCOVERY VIA VIRTUAL KNOCKOUT (SINGLE GENE MoA)
...
=>python analyze_multi_pathway.py  --signatures_dir ./moa_signatures --output_dir ./multi_pathway_analysis_results
...
STEP 11: DRUG REPURPOSING SCREEN (CONNECTIVITY MAPPING)
...
=>python analyze_repurposing_screen.py --disease_gene "TET2" --cell_line "K562" --drug_list_csv "drug_screen_experiments.csv" --output_dir "./TET2_repurposing_results"

STEP 12: UNIFIED THERAPEUTIC SCREENING (Cosine Similarity)
...
=>python synthetic_lethality_screen.py --disease_gene TET2 --cell_line K562 --target_list_csv drug_screen_experiments.csv --score_type combined --num_cells 2000
